...
define(function (require) {
	...
	Matrix.prototype.applyToVector = function (vec /* Vector3/2 */) {
		var e = this.e;
		var x, y, z;

		x = vec.x * e[0] + vec.y * e[4] + (vec.z ? vec.z : 0.0) * e[8] + e[12];
		y = vec.x * e[1] + vec.y * e[5] + (vec.z ? vec.z : 0.0) * e[9] + e[13];
		z = vec.x * e[2] + vec.y * e[6] + (vec.z ? vec.z : 0.0) * e[10] + e[14];
		vec.set(x, y, z);
		return vec;
	}

	// Deprecated
	Matrix.prototype.applyToVec = function (vec /* Vector3/2 */) {
	...
	Matrix.prototype.setAxes = function (xVec, yVec, zVec /* opt */) {
		var e = this.e;
	...
	Matrix.prototype.setAxes2 = function (xVec, yVec, zVec /* opt */) {
		var e = this.e;
		if (zVec == undefined) zVec = new Vector3(0, 0, 1);
	...
	Matrix.prototype.setToTranslation = function (x, y, z /* opt */) {
		var e = this.e;
	...
	Matrix.prototype.translate = function (x, y, z /* opt */) {
		var e = this.e;
		if (z == undefined) z = 0.0;
	...
	Matrix.prototype.addTranslation = function (x, y, z /* opt */) {
		var e = this.e;
		e[12] += x;
		e[13] += y;
		if (z) e[14] += z;
	...
	Matrix.prototype.scaleUniform = function (factor) {
		this.scale(factor, factor, factor);
	};

	Matrix.prototype.scale = function (x, y, z /* opt */) {
		var m = new Matrix();
		m.setToScale(x, y, z);
		this.premultiply(m);
	};

	Matrix.prototype.setToScale = function (x, y, z /* opt */) {
		if (z == undefined) z = 1.0;
		this.setToIdentity();
		this.e[0] = x;	this.e[5] = y;	this.e[10] = z;
	};

	Matrix.fromRotation = function (x, y, z, angle /* radians */) {
		if (z == null) z = 0.0;
		var m = new Matrix();
	...
	Matrix.fromZXVectors = function (zVector, xVector, translation /* opt */) {
		var m = new Matrix();
