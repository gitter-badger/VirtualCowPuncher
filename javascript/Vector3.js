...
define(function (require) {
	...
	Vector3.prototype.withLength = function (newLength) {
		var vec = this.clone();
	...
	// returns number
	Vector3.prototype.dot = function (other /* Vector3 */) {
		return other.x * this.x + other.y * this.y + other.z * this.z;
	};

	// returns vector
	Vector3.prototype.cross = function (other /* Vector3 */) {
	...
	Vector3.prototype.angle = function (other /* Vector3 */) {
	...
	Vector3.Angle = function (vec1, vec2) {
